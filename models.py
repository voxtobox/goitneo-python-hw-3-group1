    ...
    def __init__(self, phone):
        if phone.isdigit() and len(phone) == 10:
            ...
            raise IncorrectFormatException(
                'Incorrect phone format, should be 10 digit')
...
class Birthday(Field):
    def __init__(self, birthday):
        try:
            ...
            raise IncorrectFormatException(
                'Incorrect birthday format, should be DD.MM.YYYY')
...
class AddressBook(UserDict[Name, Record]):
    ...
    def get_birthdays_per_week(self):
        ...
        for contact in self.data.values():
            ...
            birthday_this_year = self.__get_user_birthday_this_year(
                birthday, today)
            birthday_this_year = self.__get_norm_weekday_user_birthday(
                birthday_this_year)
